...
experiment_folder_name="${trace_name}__${current_date}"
...
python3 -m cache_replacement.policy_learning.cache_model.main \
  ...
  --train_memtrace=cache_replacement/policy_learning/cache/traces/${trace_name}.csv \
  --valid_memtrace=cache_replacement/policy_learning/cache/traces/${trace_name}.csv
