...
python3 -m cache_replacement.policy_learning.cache_model.main \
  ...
  --experiment_name=libquantum_1210B_v1 \
  --cache_configs=cache_replacement/policy_learning/cache/configs/default.json \
  --model_bindings="loss=[\"log_likelihood\", \"reuse_dist\"]" \
  --model_bindings="address_embedder.max_vocab_size=5000" \
  --train_memtrace=cache_replacement/policy_learning/cache/traces/libquantum_1210B_train.csv \
  --valid_memtrace=cache_replacement/policy_learning/cache/traces/libquantum_1210B_valid.csv
