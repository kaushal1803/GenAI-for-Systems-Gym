...
python3 -m cache_replacement.policy_learning.cache.main \
  ...
  --experiment_name=eval_milc_409B_test \
  --cache_configs="cache_replacement/policy_learning/cache/configs/default.json" \
  --cache_configs="cache_replacement/policy_learning/cache/configs/eviction_policy/learned.json" \
  --memtrace_file="cache_replacement/policy_learning/cache/traces/milc_409B_test.csv" \
  --config_bindings="associativity=16" \
  --config_bindings="capacity=2097152" \
  --config_bindings="eviction_policy.scorer.checkpoint=\"experiments/milc_409B_v1/checkpoints/20000.ckpt\"" \
  --config_bindings="eviction_policy.scorer.config_path=\"experiments/milc_409B_v1/model_config.json\"" \
  --warmup_period=0
